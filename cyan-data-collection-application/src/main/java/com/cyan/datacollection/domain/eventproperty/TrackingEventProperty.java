...
public class TrackingEventProperty {
     ...
     * 校验并保存事件属性关系
     */
    public TrackingEventProperty save(TrackingEventPropertyRepository repository) {
     ...
     * 校验并更新事件属性关系
     */
    public TrackingEventProperty update(TrackingEventPropertyRepository repository) {
     ...
     * 删除事件属性关系
     */
    public void delete(TrackingEventPropertyRepository repository) {
        Assert.notBlank(this.id, new SilentException("事件属性关系ID不能为空"));
